...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		var post1 = new Post(null, sdf.parse("21032018"), "Off on a trip", "Im traveling to So Paulo. Cheers!", maria);
		var post2 = new Post(null, sdf.parse("23032018"), "Good morning", "I woke up happy today!", maria);
